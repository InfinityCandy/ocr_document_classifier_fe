...
import { Container, Typography, TextField, Button, Card, CardContent, CardMedia, CircularProgress, Alert, MenuItem, Select, InputLabel, FormControl } from '@mui/material';
...
const DocumentDetailPage = () => {
  ...
  return (
    <Container sx={{ mt: 4 }}>
      ...
      <Card>
        {/* <CardMedia component="img" height="200" image={document.imageUrl} alt={document.name} /> */}
        <CardContent>
          <Typography variant="h5" gutterBottom>Edit Document</Typography>
          <TextField
            label="Name"
            name="name"
            value={form.name}
